...
@implementation KKPosterizeEffect
{
...
- (id)initWithSuperView:(UIView*)superview
{
    ...
    if(self){
        ...
        _radiusSlider = [self sliderWithValue:sliderValue minimumValue:-10 maximumValue:-2.0];
...
- (UIImage*)applyEffect:(UIImage*)image
{
    ...
    [filter setDefaults];
    [filter setValue:[NSNumber numberWithFloat:-sliderValue] forKey:@"inputLevels"];
